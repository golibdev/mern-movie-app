      ...
      <>
         ...
         <Box marginTop="-4rem" sx={{ ...uiConfigs.style.mainContent }}>
            ...
            <Container header="top rated movies">
               <MediaSlide mediaType={tmdbConfigs.mediaType.movie} mediaCategory={tmdbConfigs.mediaCategory.topRated} />
            </Container>

            <Container header="top rated series">
               <MediaSlide mediaType={tmdbConfigs.mediaType.tv} mediaCategory={tmdbConfigs.mediaCategory.topRated} />
            </Container>
         </Box>
      </>
   )
